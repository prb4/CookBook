...
class AdapterFoodChoice(
...
) : RecyclerView.Adapter<com.cookbook.AdapterFoodChoice.FoodViewHolder>() {

    val TAG = "CookBook - AdapterFoodChoice.kt"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterFoodChoice.FoodViewHolder {
        Log.d(TAG, "in onCreateViewHolder")
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_card, parent, false)
        return FoodViewHolder(view)
    }

    override fun onBindViewHolder(holder: AdapterFoodChoice.FoodViewHolder, position: Int) {
